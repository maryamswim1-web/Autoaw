    ...
    >
      <div className="mx-auto max-w-7xl px-6 h-16 flex items-center justify-between">
        <a href="#top" className="flex items-center gap-2.5">
          <LogoMark />
          <span className="font-semibold tracking-tight">Atlas Autoware</span>
        </a>
        ...
        <Link to="/sponsors" className="btn-donate text-sm !py-2 !px-4 inline-flex items-center gap-2">
          Donate 🤍
        </Link>
      </div>
    </header>
      ...
      <div className="mx-auto max-w-7xl px-6 pt-16 pb-20 grid lg:grid-cols-12 gap-12 items-center">
        <div className="lg:col-span-6 animate-fade-up">
          ...
          <div className="mt-9 flex flex-wrap items-center gap-3">
            ...
            <Link to="/sponsors" className="btn-donate">
              Chip In
        ...
        <div className="lg:col-span-6 relative h-[720px] flex items-center justify-center">
    ...
    <section id="team" className="py-20 md:py-28 border-t border-white/10">
      <div className="mx-auto max-w-7xl px-6">
        <div className="max-w-2xl mx-auto text-center">
          ...
          <h2 className="mt-6 text-4xl md:text-5xl font-semibold tracking-tight text-gradient whitespace-nowrap">
    ...
    <section className="py-20 md:py-24 border-t border-white/10">
      <div className="mx-auto max-w-6xl px-6 text-center">
        ...
        <div className="mt-9 flex flex-wrap justify-center items-center gap-3">
          <Link to="/sponsors" className="btn-donate inline-flex items-center gap-2">
            Help us out 🤍
          </Link>
          ...
          <div className="mt-8 space-y-5">
            {points.map((p) => (
              <div key={p.title} className="flex gap-4">
                <div className="shrink-0 w-7 h-7 rounded-md bg-brand grid place-items-center shadow-glow">
      ...
      <div className="mx-auto max-w-7xl px-6">
        ...
        <div className="mt-12 grid md:grid-cols-3 gap-8">
          <div className="text-center">
            ...
            <Link
              to="/sponsors"
              className="block rounded-2xl border-2 border-yellow-400/30 bg-yellow-400/5 p-8 h-[220px] flex items-center justify-center transition-all duration-300 hover:-translate-y-1 hover:border-yellow-400 hover:shadow-[0_0_32px_rgba(250,204,21,0.35)]"
            >
              <p className="text-sm text-muted-foreground">Become a Sponsor</p>
            </Link>
          </div>
          <div className="text-center">
            <div className="inline-flex items-center gap-2 mb-6">
            ...
            <a
              ...
              target="_blank"
              rel="noopener noreferrer"
              className="block rounded-2xl border-2 border-slate-300/30 bg-white p-8 h-[220px] flex items-center justify-center transition-all duration-300 hover:-translate-y-1 hover:border-slate-300 hover:shadow-[0_0_32px_rgba(203,213,225,0.35)]"
            >
            ...
            <a
              ...
              target="_blank"
              rel="noopener noreferrer"
              className="mt-4 block rounded-2xl border-2 border-slate-300/30 bg-white p-8 h-[180px] flex items-center justify-center transition-all duration-300 hover:-translate-y-1 hover:border-slate-300 hover:shadow-[0_0_32px_rgba(203,213,225,0.35)]"
            >
          ...
          <div className="text-center">
            ...
            <a
              ...
              target="_blank"
              rel="noopener noreferrer"
              className="block rounded-2xl border-2 border-amber-600/30 bg-white p-8 h-[220px] flex items-center justify-center transition-all duration-300 hover:-translate-y-1 hover:border-amber-600 hover:shadow-[0_0_32px_rgba(217,119,6,0.35)]"
            >
            ...
            <a
              ...
              target="_blank"
              rel="noopener noreferrer"
              className="mt-4 block rounded-2xl border-2 border-amber-600/30 bg-white p-8 h-[180px] flex items-center justify-center transition-all duration-300 hover:-translate-y-1 hover:border-amber-600 hover:shadow-[0_0_32px_rgba(217,119,6,0.35)]"
            >
              <img src={openmvLogo} alt="OpenMV" className="max-h-28 w-auto object-contain" />
            </a>
            <a
