  ...
  return (
    <section className="relative pt-36 pb-20 md:pb-28 overflow-hidden">
      <div className="absolute inset-0 -z-10">
        ...
        <div className="absolute top-0 right-0 w-[800px] h-[600px] bg-brand/10 rounded-full blur-[120px] -translate-y-1/2 translate-x-1/4" />
      </div>
    ...
    <section className="py-20 md:py-28 border-t border-white/10">
      <div className="mx-auto max-w-7xl px-6">
        <div className="max-w-3xl mx-auto text-center">
          ...
          <h2 className="mt-6 text-4xl md:text-5xl font-semibold tracking-tight text-gradient leading-[1.05]">
            What happens between "sees a cone" and "doesn't hit it"
          </h2>
        </div>
